    ...
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center w-full gap-4">
        ...
        <Card
          ...
          des="We'll collaborate to define your data project’s objectives, target audience, and essential functionalities. We’ll discuss aspects such as data sources, analysis requirements, and visualization needs to ensure a comprehensive approach."
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
