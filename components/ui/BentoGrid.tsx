...
export const BentoGridItem = ({
  ...
  const leftLists = ["Python", "SQL", "PowerBI"];
  const rightLists = ["Java", "AWS", "CICD"];

  const [copied, setCopied] = useState(false);
  const [downloaded, setDownloaded] = useState(false);

  const [showCopyConfetti, setShowCopyConfetti] = useState(false);
    ...
    >
      ...
      <div className={`${id === 6 && "flex justify-center"} h-full`}>
        ...
        >
          ...
          {id === 6 && (
            <div className="mt-5 relative flex flex-col sm:flex-row sm:space-x-2 space-y-2 sm:space-y-0 justify-center items-center">
